#!/usr/bin/env python3
"""ES Asia Continuation — Variable Sweeps Round 1 (fresh start).

No prior ES Asia optimization exists. Starting from default ASIA_SESSION
...
def main():
    print("ES Asia ORB — Round 1: fresh start with default Asia config")
    print("=" * 90)
