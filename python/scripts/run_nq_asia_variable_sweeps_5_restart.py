#!/usr/bin/env python3
"""NQ Asia Continuation — Variable Sweeps Round 5 (RESTART).

R5 anchor (R4 + atr=5, flat=02:00):
  ORB: 20:00-20:15, entry until 23:15, flat 02:00-07:00
  stop=4.0%, min_gap_atr=0.9%, max_gap_pts=50.0, max_gap_atr=0.0
  rr=3.0, tp1=0.6, ATR=5, direction=long, ICF=ON, continuation, 1s magnifier
  DOW gate: none

R4 adoptions applied: atr: 14 -> 5 (+3.49), flat: 23:00 -> 02:00 (+1.31)
  atr=5 massive impact (+3.49 Calmar). flat=02:00 extends session (+1.31).
  entry_end=01:00 deferred (borderline +0.52).
...
ANCHOR = StrategyConfig(
    ...
    name="NQ Asia R5 Anchor (restart)",
)
...
def main():
    ...
    # -- 5. FLAT START TIME ----------------------------------------------------
    flat_starts = ["23:00", "00:00", "01:00", "01:30", "02:00", "02:30", "03:00", "04:00", "05:00", "06:00", "06:45"]
