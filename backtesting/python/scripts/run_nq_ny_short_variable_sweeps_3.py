#!/usr/bin/env python3
"""NQ NY Continuation Short — Variable Sweeps Round 3.

R3 anchor (from R2 adoptions: entry_end=14:00, gap=4.0%, excl-Thu):
  ORB: 09:30-09:50 (20m), entry until 14:00, flat 15:50-16:00
  stop=5.0%, min_gap_atr=4.0%, max_gap_pts=0, max_gap_atr=0
...
def main():
    ...
    # -- 4. ENTRY END TIME -----------------------------------------------------
    entry_ends = ["11:00", "12:00", "13:00", "13:30", "14:00", "14:30", "15:00", "15:30"]
    ...
    # -- 9. MIN GAP ATR % -----------------------------------------------------
    gap_vals = [1.0, 2.0, 2.5, 3.0, 3.5, 4.0, 5.0, 6.0]
