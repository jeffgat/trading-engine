#!/usr/bin/env python3
"""RTY NY Continuation — Variable Sweeps Round 1.

Starting from default NY_SESSION params for index futures.

R1 anchor:
  ORB: 09:30-09:45 (15m), entry until 12:00, flat 15:50-16:00
  stop=7.5%, min_gap_atr=2.25%, max_gap_pts=50, max_gap_atr=0 (off)
  rr=2.0, tp1=0.5, ATR=14, direction=both, ICF=OFF, continuation, 1m magnifier
  DOW gate: none
...
ANCHOR_SESSION = SessionConfig(
    ...
    entry_start="09:45",
    entry_end="12:00",       # CLAUDE.md default
    flat_start="15:50",
    flat_end="16:00",
...
def main():
    ...
    # ── Anchor ──
    print("=" * 100)
    print("  ANCHOR (default NY params)")
    print("=" * 100)
    ...
    print("=" * 100)
    print(HDR)
    for i, s in enumerate([3.0, 4.0, 5.0, 6.0, 7.5, 9.0, 10.0, 12.0], 1):
    ...
    print("=" * 100)
    print(HDR)
    for i, rr in enumerate([1.5, 2.0, 2.5, 3.0, 3.5, 4.0, 5.0], 1):
    ...
    print("=" * 100)
    print(HDR)
    for i, g in enumerate([0.5, 0.75, 1.0, 1.5, 2.0, 2.25, 2.5, 3.0], 1):
    ...
    # ── 9. DOW exclusion ──
    print("=" * 100)
    print("  SWEEP 9: DOW Exclusion")
    print("=" * 100)
    _, trades_all = run_and_metric(df, df_1m, ANCHOR)
    ...
    print("=" * 100)
    print("  R1 COMPLETE — Review sweeps above and adopt changes with Calmar Δ > +0.3")
    print("=" * 100)
