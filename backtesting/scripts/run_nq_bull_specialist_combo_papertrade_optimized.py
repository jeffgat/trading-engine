#!/usr/bin/env python3
"""Build the funded-account paper-trade package for the optimized NQ combo.

The selected combo is:
- bull_specialist
- nq_asia
- nq_asia_lsi (entry_end=23:00)
- nq_ny_lsi (min_gap_atr_pct=3.75)
"""
...
OUTPUT_DIR = ROOT / "data" / "results" / "nq_bull_specialist_combo_papertrade_optimized"
...
def make_nq_ny_lsi_gap375_config() -> StrategyConfig:
    ...
    return StrategyConfig(
        **{
            **base.__dict__,
            ...
            "notes": "NY LSI combo-context winner with min_gap_atr_pct=3.75.",
        }
    )
...
def main() -> None:
    ...
    print("NQ Bull Specialist Optimized Combo Paper-Trade Package")
    print("=" * 72)
    ...
    leg_configs = {
        ...
        "nq_asia_lsi": make_nq_asia_lsi_end2300_config(),
        "nq_ny_lsi": make_nq_ny_lsi_gap375_config(),
    }
    ...
    print("\nCombining optimized route...", flush=True)
        ...
        output_dir / "combo_paper_trade_package.json",
        {
            "selected_combo": {
                ...
                "optimization_sources": {
                    "nq_asia": str(ROOT / "data" / "results" / "nq_asia_4leg_combo_sweep" / "asia_combo_ranking.csv"),
                    "nq_asia_lsi": str(ROOT / "data" / "results" / "nq_asia_lsi_4leg_combo_sweep" / "asia_lsi_combo_ranking.csv"),
                    "nq_ny_lsi": str(ROOT / "data" / "results" / "nq_ny_lsi_4leg_combo_sweep" / "ny_lsi_combo_ranking.csv"),
                },
            },
            "funded_profile": asdict(funded_profile),
            "leg_configs": {leg_name: asdict(leg_configs[leg_name]) for leg_name in SELECTED_LEGS},
            "scorecard": scorecard,
    ...
    summary_lines = [
        "# NQ Bull Specialist Optimized Combo Paper-Trade Package",
        "",
        "## Selected Route",
        "",
        "- Combo: `bull_specialist + nq_asia + nq_asia_lsi_end2300 + nq_ny_lsi_gap3.75`.",
        "- Why this route: keeps the 4-leg structure but updates the last two legs to the combo-context winners.",
