#!/usr/bin/env python3
"""NQ NY Continuation Short — Variable Sweeps Round 6.

R6 anchor (from R5 adoptions: orb=30m, atr=20, flat=15:50, gap=4.0%, maxgap=50pts):
  ORB: 09:30-10:00 (30m), entry until 15:30, flat 15:50-16:00
  stop=5.0%, min_gap_atr=4.0%, max_gap_pts=50, max_gap_atr=0
  rr=2.0, tp1=0.2, ATR=20, direction=short, ICF=OFF, continuation, 1s magnifier
  DOW gate: excl Fri
...
def main():
    ...
    # -- 9. MIN GAP ATR % -----------------------------------------------------
    gap_vals = [1.0, 2.0, 2.5, 3.0, 3.5, 4.0, 4.5, 5.0, 6.0]
