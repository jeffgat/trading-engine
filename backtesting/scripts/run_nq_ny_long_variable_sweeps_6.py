#!/usr/bin/env python3
"""NQ NY Continuation — Variable Sweeps Round 6 (Longs-Only Fresh Start).

R6 anchor (R5 + 2 adoptions):
  ORB: 09:30-09:50 (20m), entry until 12:00, flat 15:30-16:00
  stop=9.0%, min_gap_atr=2.5%, max_gap_pts=100.0, max_gap_atr=0.0
  rr=3.0, tp1=0.6, ATR=20, direction=long, ICF=OFF, continuation, 1s magnifier
  DOW gate: excl Fri

R5 adoptions applied:
  flat_start: 14:30 -> 15:30 (+0.58)
  tp1_ratio: 0.5 -> 0.6 (+1.18)
