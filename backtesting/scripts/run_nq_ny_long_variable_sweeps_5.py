#!/usr/bin/env python3
"""NQ NY Continuation — Variable Sweeps Round 5 (Longs-Only Fresh Start).

R5 anchor (R4 + 1 adoption):
  ORB: 09:30-09:50 (20m), entry until 12:00, flat 14:30-16:00
  stop=9.0%, min_gap_atr=2.5%, max_gap_pts=100.0, max_gap_atr=0.0
  rr=3.0, tp1=0.5, ATR=20, direction=long, ICF=OFF, continuation, 1s magnifier
  DOW gate: excl Fri

R4 adoption applied:
  atr_length: 7 -> 20 (+1.65)

ATR has oscillated 12->20->7->20 across R2-R5. If it flips again, lock at 20 (higher Calmar).
...
def main():
    ...
    # -- 1-12: same 12 dimensions as R4 ---
    for dim_num, dim_name, vals, build_fn in [
        (1, "ORB WINDOW", [
