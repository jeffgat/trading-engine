#!/usr/bin/env python3
"""NQ Asia Continuation — Variable Sweeps Round 8 (RESTART).

R8 anchor (R7 + flat=04:00):
...
R7 adoption applied: flat: 02:00 -> 04:00 (+0.46)
  DOW excl Tue persisted from R6 (confirmed stable).
...
ANCHOR = StrategyConfig(
    ...
    name="NQ Asia R8 Anchor (restart)",
)
