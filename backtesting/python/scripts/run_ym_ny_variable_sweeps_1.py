#!/usr/bin/env python3
"""YM NY Long Continuation — Variable Sweeps Round 1.

Starting from WF mode params (WFE 0.56, stability 0.83).
...
def main():
    ...
    # ── Anchor ──
    print("=" * 100)
    print("  ANCHOR (WF mode params: rr=3.0, stop=7.5%, gap=1.0%, tp1=0.4, long-only)")
    print("=" * 100)
