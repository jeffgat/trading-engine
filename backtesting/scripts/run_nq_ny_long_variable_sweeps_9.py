#!/usr/bin/env python3
"""NQ NY Continuation — Variable Sweeps Round 9 (Longs-Only Fresh Start).

R9 anchor (R8 + 1 adoption):
  ORB: 09:30-09:50 (20m), entry until 12:00, flat 15:30-16:00
  stop=7.0%, min_gap_atr=2.5%
  rr=3.25, tp1=0.45, ATR=12, direction=long, ICF=ON, continuation, 1s magnifier
  DOW gate: excl Fri

R8 adoption applied:
  atr_length: 20 -> 12 (+0.34)

ATR history: 12->20->7->20->20->20->20->12. Tighter stop (7%) may prefer shorter ATR.
