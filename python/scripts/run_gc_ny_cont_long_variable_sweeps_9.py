#!/usr/bin/env python3
"""Step 2 — Variable Sweeps Round 9: GC NY Continuation Longs.

Anchor (from R8 adoptions):
...
Changes from R8: flat 15:50→14:30, max_gap_atr 25%→30%
"""
...
GC_NY = SessionConfig(
    ...
    entry_start="09:38",
    entry_end="12:00",
    flat_start="14:30",       # adopted R8
    flat_end="16:00",
    stop_atr_pct=4.5,
    min_gap_atr_pct=3.0,
    max_gap_atr_pct=30.0,     # adopted R8
)
...
if __name__ == "__main__":
    print(f"\n{'='*90}")
    print("  GC NY CONT LONGS — VARIABLE SWEEPS ROUND 9")
    ...
    print(f"\n{'='*90}")
    print(f"  ROUND 9 SUMMARY — Anchor Calmar: {anchor_calmar:.2f} | Neg years: {anchor_neg}")
    print(f"{'='*90}")
