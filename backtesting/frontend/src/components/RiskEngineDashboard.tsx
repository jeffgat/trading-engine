...
import type { BacktestHistoryItem, BacktestResult, Trade } from "../lib/types";
import { formatR, pnlColor } from "../lib/utils";
...
export function RiskEngineDashboard() {
  ...
  const fetchStrategyData = useCallback((id: string) => {
    ...
    fetch(`/api/backtests/${id}`, { signal: controller.signal })
      .then((res) => res.json())
      .then((json) => {
