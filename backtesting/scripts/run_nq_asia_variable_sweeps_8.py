#!/usr/bin/env python3
"""NQ Asia Continuation — Variable Sweeps Round 8.

R8 anchor (R7 + maxgap=10pts):
  ORB: 20:00-20:15, entry until 03:00, flat 04:00-07:00
  stop=5.25%, min_gap_atr=1.0%, max_gap_pts=10.0, max_gap_atr=0.0
  rr=2.5, tp1=0.05, ATR=7, direction=both, ICF=OFF, continuation, 1s magnifier
  DOW gate: none

R7 adoptions applied: maxgap: 50pts -> 10pts (+0.56)
  Near-convergence — only 1 adoption from 12 dimensions.
  All other dimensions at delta=0.00 (skip).
  Calmar jumped from 16.79 (R6) to 21.23 (R7).
