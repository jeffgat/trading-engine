#!/usr/bin/env python3
"""RTY ORB Discovery Pipeline — top candidates from 3-session sweep.

Candidates from run_rty_orb_discovery.py (pre-holdout <2025-01):
  NY-1:  10m ORB, ORB 75%, RR=3.5, TP1=0.6, both  (Cal 8.84, 0 neg, DD -20.6R, Score 6.35)
  NY-2:  10m ORB, ORB 100%, RR=3.5, TP1=0.6, both (Cal 7.47, 0 neg, DD -20.9R, Score 5.54)
  NY-3:  10m ORB, ORB 100%, RR=2.0, TP1=0.5, both (Cal 7.51, 0 neg, DD -13.8R, Score 5.20)
  NY-4:  10m ORB, ORB 100%, RR=3.0, TP1=0.4, both (Cal 7.15, 0 neg, DD -17.5R, Score 5.25)
  LDN-1: 30m ORB, ORB 25%, RR=2.0, TP1=0.6, long (Cal 3.44, 0 neg, DD -21.3R, Score 3.18)
  LDN-2: 10m ORB, ATR 5%, RR=2.0, TP1=0.6, long  (Cal 5.53, 1 neg, DD -19.8R, Score 3.00)

Asia dead — all configs 2+ neg years. Not included.
...
OUTPUT_DIR = ROOT / "data" / "results" / "rty_orb_discovery_pipeline"
...
# ---------------------------------------------------------------------------
# 6 candidates (NY top 4, LDN top 2)
# ---------------------------------------------------------------------------
...
CANDIDATES = {
    ...
    "LDN-1": StrategyConfig(
        ...
        name="RTY LDN-1 30m ORB25 RR2.0 TP0.6 long"),
...
def main():
    print("RTY ORB Discovery Pipeline — 6 Candidates (1m magnifier)")
    print("=" * 70)
    t0 = time.time()
