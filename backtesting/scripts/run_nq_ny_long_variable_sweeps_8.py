#!/usr/bin/env python3
"""NQ NY Continuation — Variable Sweeps Round 8 (Longs-Only Fresh Start).

R8 anchor (from Grid Sweep R1 winner, 0-neg-years):
  ORB: 09:30-09:50 (20m), entry until 12:00, flat 15:30-16:00
  stop=7.0%, min_gap_atr=2.5%, max_gap_pts=100.0, max_gap_atr=0.0
  rr=3.25, tp1=0.45, ATR=20, direction=long, ICF=ON, continuation, 1s magnifier
  DOW gate: excl Fri

Grid winner (0-neg): Calmar 16.45 vs old anchor 14.45 (delta +2.00)
WARNING: 2023 at +0R — borderline. Many dimensions may be blocked by 2023 going negative.
...
def main():
    ...
    # -- 8. REWARD:RISK --------------------------------------------------------
    rr_vals = [1.5, 2.0, 2.5, 3.0, 3.25, 3.5, 4.0, 5.0]
    ...
    # -- 9. TP1 RATIO ---------------------------------------------------------
    tp1_vals = [0.2, 0.3, 0.4, 0.45, 0.5, 0.6, 0.7]
