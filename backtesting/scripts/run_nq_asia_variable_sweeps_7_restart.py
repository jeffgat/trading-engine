#!/usr/bin/env python3
"""NQ Asia Continuation — Variable Sweeps Round 7 (RESTART).

R7 anchor (R6 + DOW excl Tue):
  ORB: 20:00-20:15, entry until 23:00, flat 02:00-07:00
  stop=4.0%, min_gap_atr=0.9%, max_gap_pts=75.0, max_gap_atr=0.0
  rr=3.0, tp1=0.6, ATR=5, direction=long, ICF=ON, continuation, 1s magnifier
  DOW gate: excl Tue

R6 adoption applied: DOW excl none -> excl Tue (+0.98)
  Note: DOW exclusion has been unstable across rounds — testing persistence.
...
ANCHOR = StrategyConfig(
    ...
    name="NQ Asia R7 Anchor (restart)",
)
