#!/usr/bin/env python3
"""Phase-One Robust Pipeline — SI NY HTF-LSI frozen shortlist."""
...
SHORTLIST_SOURCE = ROOT / "data" / "results" / "si_ny_htf_lsi_stitched_followup" / "summary.json"
STITCHED_REPORT_PATH = ROOT / "learnings" / "reports" / "SI_NY_HTF_LSI_STITCHED_FOLLOWUP.md"
OUTPUT_DIR = ROOT / "data" / "results" / "si_ny_htf_lsi_phase_one"
REPORT_PATH = ROOT / "learnings" / "reports" / "SI_NY_HTF_LSI_PHASE_ONE.md"
...
def main() -> None:
    print("Phase-One Robust Pipeline — SI NY HTF-LSI", flush=True)
    print("=" * 72, flush=True)
    ...
    print("\nLoading SI 5m HTF-LSI data (5m + 1m + 1s)...", flush=True)
    df_base, df_1m, df_1s, signal_df_1m = load_timeframe_data("SI", "5m")
