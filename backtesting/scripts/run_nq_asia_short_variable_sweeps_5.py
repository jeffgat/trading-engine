#!/usr/bin/env python3
"""NQ Asia Continuation SHORT — Variable Sweeps Round 5.

R5 anchor (R4 + entry_end=01:00, rr=3.5):
  ORB: 20:00-20:10, entry until 01:00, flat 23:00-07:00
  stop=3.5%, min_gap_atr=1.0%, max_gap_pts=0, max_gap_atr=0
  rr=3.5, tp1=0.6, ATR=30, direction=short, ICF=ON, continuation, 1s magnifier
  DOW gate: excl Thu

R4 adoptions: entry_end 23:00->01:00 (+0.37), rr 3.0->3.5 (+0.91)
...
def main():
    ...
    # -- 4. ENTRY END TIME -----------------------------------------------------
    entry_ends = ["22:00", "22:30", "23:00", "23:30", "00:00", "00:30", "01:00", "01:30", "02:00", "03:00"]
    ...
    # -- 7. REWARD:RISK --------------------------------------------------------
    rr_vals = [2.5, 3.0, 3.25, 3.5, 3.75, 4.0, 4.5, 5.0, 6.0]
