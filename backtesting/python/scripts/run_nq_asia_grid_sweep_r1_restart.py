#!/usr/bin/env python3
"""NQ Asia Grid Sweep R1 (RESTART) -- 4D grid centered on converged anchor.

Anchor (from variable sweeps R2):
  ORB: 20:00-20:15, entry until 23:15, flat 23:00-07:00
  stop=5.25%, rr=4.0, gap=0.9%, tp1=0.5
  ATR=14, direction=both, ICF=OFF, continuation, 1s magnifier
  DOW gate: none
...
ANCHOR = StrategyConfig(
    ...
    name="NQ Asia Grid Sweep R1 (restart)",
)

# Grid dimensions -- narrow range centered on anchor
STOPS = [4.0, 5.0, 5.25, 6.0, 7.5]
