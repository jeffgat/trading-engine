#!/usr/bin/env python3
"""ES Asia Continuation — Variable Sweeps Round 4.
...
R4 anchor (adopted from R3):
  ...
  rr=2.0, tp1=0.3, ATR=5, direction=long, ICF=OFF, continuation, 1s magnifier
  DOW gate: excl Thu

R3 adoption (Calmar Δ > +0.3, no new neg years):
  direction:  both → long (+4.19)
...
def main():
    print("ES Asia ORB — Round 4: re-sweep on R3 adopted anchor (long-only)")
    print("=" * 90)
