#!/usr/bin/env python3
"""NQ Asia Continuation — Variable Sweeps Round 4.

R4 anchor (R3 + entry_end/gap adoptions):
  ORB: 20:00-20:15, entry until 03:00, flat 06:45-07:00
...
R3 adoptions applied: entry_end: 23:15 -> 03:00 (+4.46), gap: 1.0% -> 0.9% (+0.57)
  excl Tue did NOT persist (skip in R3) — confirmed data-mining artifact
  ICF=ON did NOT persist (skip in R3)
