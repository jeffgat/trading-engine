#!/usr/bin/env python3
"""NQ Asia Continuation — Variable Sweeps Round 2.

R2 anchor (R1 + tp1 adoption):
  ORB: 20:00-20:15, entry until 23:15, flat 06:45-07:00
  stop=5.25%, min_gap_atr=0.9%, max_gap_pts=50.0, max_gap_atr=0.0
  rr=2.5, tp1=0.05, ATR=14, direction=both, ICF=OFF, continuation, 1s magnifier
  DOW gate: none

R1 adoptions applied: tp1: 0.5 -> 0.05 (Calmar delta +12.39)
  (7 other adoptions deferred to avoid destructive interaction)
