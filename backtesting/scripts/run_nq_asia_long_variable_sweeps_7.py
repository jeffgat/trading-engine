#!/usr/bin/env python3
"""NQ Asia Long — Variable Sweeps Round 7 (Full ORB Anchor).

R7 anchor (R6 + adoptions):
...
R6 adoptions applied:
  min_gap_orb_pct: 5% -> 7% (+0.54)
  entry_end: 00:00 -> 22:30 (+0.99)
  rr: 8.0 -> 6.0 (+0.35)

Oscillation dampening — rr barely triggered (0.35), tp1 held stable.
Expecting convergence or near-convergence.
...
ANCHOR = StrategyConfig(
    ...
    name="NQ Asia Long R7 Anchor (full ORB)",
)
