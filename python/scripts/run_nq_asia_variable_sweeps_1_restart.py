#!/usr/bin/env python3
"""NQ Asia Continuation — Variable Sweeps Round 1 (RESTART).
...
RESTART: Previous R1-R8 series invalidated by degenerate tp1=0.05.
NEW RULE: tp1_ratio >= 0.2 minimum (parallel to median stop >= 10 ticks rule).
...
ANCHOR = StrategyConfig(
    ...
    name="NQ Asia R1 Anchor (restart)",
)
