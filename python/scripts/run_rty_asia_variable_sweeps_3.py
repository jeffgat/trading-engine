#!/usr/bin/env python3
"""RTY Asia Continuation — Variable Sweeps Round 3.
...
ANCHOR = StrategyConfig(
    ...
    name="RTY Asia R3 Anchor",
)

ANCHOR_DOW_EXCL = {1}  # ← R2 adoption: excl Tue
...
def main():
    print("RTY Asia ORB — Round 3: excl Tue adopted from R2")
    print("=" * 90)
    ...
    # ── 1. STOP ATR % ────────────────────────────────────────────────
    stop_values = [2.0, 3.0, 4.0, 5.0, 5.25, 6.0, 7.0, 8.0, 10.0]
    ...
    orb_windows = [
        ...
        ("8m",  "20:00", "20:10", "20:10"),  # 8m = 10m on 5m bars
    ...
    # ── 9. DOW EXCLUSION (with Tue already excluded) ──────────────────
    dow_sets = [
        ("Tue only",       {1}),
        ("Tue+Mon",        {0, 1}),
        ("Tue+Wed",        {1, 2}),
