#!/usr/bin/env python3
"""NQ NY Continuation Short — Variable Sweeps Round 5.

R5 anchor (from R4 adoptions: orb=25m, atr=14, flat=14:30, gap=2.0%):
  ORB: 09:30-09:55 (25m), entry until 15:30, flat 14:30-16:00
  stop=5.0%, min_gap_atr=2.0%, max_gap_pts=0, max_gap_atr=0
