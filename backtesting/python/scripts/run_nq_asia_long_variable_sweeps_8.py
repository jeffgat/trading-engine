#!/usr/bin/env python3
"""NQ Asia Long — Variable Sweeps Round 8 (Full ORB Anchor).

R8 anchor (R7 + adoptions):
  ORB: 20:00-20:15, entry until 23:00, flat 04:00-07:00
  stop_orb_pct=100%, min_gap_orb_pct=10%
  rr=6.0, tp1=0.3, ATR=5, direction=long, ICF=OFF, continuation, 1s magnifier
  DOW gate: excl Tue

R7 adoptions applied:
  min_gap_orb_pct: 7% -> 10% (+4.16)
  entry_end: 22:30 -> 23:00 (+0.36)

rr/tp1/flat_start all held stable in R7. Expecting convergence.
...
ANCHOR = StrategyConfig(
    ...
    name="NQ Asia Long R8 Anchor (full ORB)",
)
...
def main():
    ...
    # -- 4. ENTRY END TIME -----------------------------------------------------
    entry_ends = ["21:00", "21:30", "22:00", "22:30", "23:00", "23:30", "00:00", "00:30"]
