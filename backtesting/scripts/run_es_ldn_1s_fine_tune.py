#!/usr/bin/env python3
"""ES LDN Continuation Both — Fine-tune grid around grid sweep winner (1s magnifier).

Grid sweep winner: stop=1.0%, rr=4.5, gap=3.0%, tp1=0.7
Structural: ORB 10m, flat 07:30, ATR 50, both dir, 1s magnifier

Fine-tune grid (higher resolution around winner):
  stop_atr_pct:    [0.5, 0.75, 1.0, 1.25, 1.5]                = 5
  rr:              [3.5, 4.0, 4.25, 4.5, 4.75, 5.0, 5.5]      = 7
  min_gap_atr_pct: [2.0, 2.25, 2.5, 2.75, 3.0, 3.25, 3.5]    = 7
  tp1_ratio:       [0.5, 0.6, 0.65, 0.7, 0.75, 0.8]           = 6
  Total: 1,470 combos
"""
...
# -- Structural config (locked from variable sweep + grid sweep) ---------------
...
STOP_VALUES = [0.5, 0.75, 1.0, 1.25, 1.5]
RR_VALUES = [3.5, 4.0, 4.25, 4.5, 4.75, 5.0, 5.5]
GAP_VALUES = [2.0, 2.25, 2.5, 2.75, 3.0, 3.25, 3.5]
TP1_VALUES = [0.5, 0.6, 0.65, 0.7, 0.75, 0.8]
...
def main():
    print()
    print("=" * 70)
    print("  ES LDN CONTINUATION — FINE-TUNE GRID (1s magnifier)")
    print(f"  Anchor: stop=1.0% | rr=4.5 | gap=3.0% | tp1=0.7")
    print(f"  Structural: ORB 10m | flat 07:30 | ATR 50 | both")
    ...
    print()
    print("=" * 70)
    print("  DONE — Next: re-sweep variables on winning anchor, then pipeline.")
    print("=" * 70)
    print()
