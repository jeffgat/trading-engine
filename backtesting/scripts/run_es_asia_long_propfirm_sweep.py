#!/usr/bin/env python3
"""Prop firm phase 1 sweep: ES Asia Continuation Long

Anchor config from "ES Asia Long ORB Final":
  stop=3.0%, rr=2.0, gap=0.5%, tp1=0.5, ORB=10m (20:00-20:10),
...
PARAM_GRID = {
    ...
    "asia_stop_atr_pct": [2.0, 2.5, 3.0, 3.5, 4.0],
    "asia_min_gap_atr_pct": [0.25, 0.5, 0.75, 1.0],
}

# DOW variants
DOW_VARIANTS = [
    ("thu_only", (3,)),       # Exclude Thu (anchor)
    ("no_excl", ()),          # No exclusion
    ("wed_thu", (2, 3)),      # Exclude Wed+Thu
]
...
def main():
    ...
    output_path = Path(__file__).parent.parent / "data" / "results" / "es_asia_long_propfirm_sweep.json"

    save_data = {
        "sweep_info": {
            "anchor_name": "ES Asia Long ORB Final",
