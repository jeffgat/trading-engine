#!/usr/bin/env python3
"""NQ NY Continuation Short — Variable Sweeps Round 4.

R4 anchor (from R3 adoptions: atr=20, entry_end=15:30, gap=3.5%, excl Fri):
  ORB: 09:30-09:50 (20m), entry until 15:30, flat 15:50-16:00
  stop=5.0%, min_gap_atr=3.5%, max_gap_pts=0, max_gap_atr=0
