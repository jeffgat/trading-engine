#!/usr/bin/env python3
"""ES LDN Continuation Both — Variable Sweeps Round 11.

R10 adoption: Max Gap OFF→20%ATR (Calmar 9.18, 0 neg years).
Anchor: stop=6.0%, rr=4.0, gap=1.0%, tp1=0.5, ATR=14, max_gap=20%ATR
...
if __name__ == "__main__":
    print("=" * 90)
    print("  ES LDN CONTINUATION BOTH — VARIABLE SWEEPS ROUND 11")
    print("=" * 90)
    print(f"  Anchor: stop=6%, rr=4.0, gap=1.0%, tp1=0.5, ATR=14, max_gap=20%ATR, ORB 10m")
    print(f"  Flat 08:20, entry 08:25, both, DOW excl Mon, ICF off, 1s mag")
    print(f"  R10 adoption: Max Gap OFF→20%ATR\n")
    ...
    print(f"\n\n{'='*90}")
    print(f"  SUMMARY — Variable Sweeps Round 11 ({total_time:.0f}s)")
    print(f"{'='*90}")
    ...
    if not adoptions:
        ...
        print(f"\n  Final anchor: stop=6%, rr=4.0, gap=1.0%, tp1=0.5, ATR=14, max_gap=20%ATR")
