#!/usr/bin/env python3
"""NQ Asia Continuation — Variable Sweeps Round 6.

R6 anchor (R5 + orb revert + flat adoption):
  ORB: 20:00-20:15, entry until 03:00, flat 23:00-07:00
...
R5 adoptions applied: orb: 30m -> 15m (+5.15, reverted to known-good), flat: 06:45 -> 23:00 (+3.39)
  ORB oscillation detected (15m->30m->15m) — locking at 15m
  Gap oscillation (0.9->1.0 repeated) — keeping at 1.0, grid sweep will resolve
  entry_end/stop/ATR deferred
