#!/usr/bin/env python3
"""NQ Asia Continuation — Variable Sweeps Round 3.

R3 anchor (R2 + atr/gap adoptions):
...
R2 adoptions applied: atr: 14 -> 7 (+2.02), gap: 0.9% -> 1.0% (+0.90)
  (excl Tue and ICF=ON deferred — DOW needs 2+ round confirmation)
