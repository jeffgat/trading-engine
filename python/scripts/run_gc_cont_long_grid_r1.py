#!/usr/bin/env python3
"""GC NY Continuation Longs — Grid Sweep R1 (clean data, 1s magnifier).

Anchor (confirmed stable after R1 variable sweeps on clean data):
...
if __name__ == "__main__":
    print()
    print("=" * 70)
    print("  GC NY CONT LONGS — GRID SWEEP R1 (clean data, 1s magnifier)")
    ...
    anchor_rank = next(
        (i for i, r in enumerate(scored)
         if r["stop"] == 4.0 and r["rr"] == 4.5 and r["min_gap"] == 2.5 and r["tp1"] == 0.5),
        -1,
    )
