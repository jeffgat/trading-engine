#!/usr/bin/env python3
"""NQ Asia Continuation — Variable Sweeps Round 9 (RESTART).

R9 anchor (R8 + entry_end=22:30):
...
R8 adoption applied: entry_end: 23:00 -> 22:30 (+0.97)
...
ANCHOR = StrategyConfig(
    ...
    name="NQ Asia R9 Anchor (restart)",
)
