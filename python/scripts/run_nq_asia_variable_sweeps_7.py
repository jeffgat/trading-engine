#!/usr/bin/env python3
"""NQ Asia ORB — Variable sweeps round 7 (R3): post bug fix, updated anchor.

R2 (sweeps_6) adopted 1 change:
  - flat_start: 00:00 -> 01:00 (Δ+0.91)

R3 anchor:
  ORB: 20:00-20:10 (10m), entry until 00:00, flat 01:00
...
ANCHOR_SESSION = SessionConfig(
    ...
    entry_start="20:10",
    entry_end="00:00",
    flat_start="01:00",      # R2 adopted (was 00:00)
    flat_end="07:00",
    stop_atr_pct=3.7,
...
def main():
    print("NQ Asia ORB — Round 7 (R3): flat_start=01:00")
    print("=" * 90)
    print(f"Anchor: rr={ANCHOR.rr}, tp1={ANCHOR.tp1_ratio}, "
          f"stop={ANCHOR_SESSION.stop_atr_pct}%, gap={ANCHOR_SESSION.min_gap_atr_pct}%")
    print(f"ORB=10m (20:00-20:10), entry<=00:00, flat=01:00, ATR={ANCHOR.atr_length}, "
    ...
    if not any_adopted:
        ...
        print(f"  Update anchor and re-sweep as R4")
