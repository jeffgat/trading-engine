#!/usr/bin/env python3
"""NQ NY Continuation Short — Variable Sweeps Round 2.

R2 anchor (from R1 adoptions: entry_end=11:00, tp1=0.2):
  ORB: 09:30-09:50 (20m), entry until 11:00, flat 15:50-16:00
...
def check_adopt(label, m, anchor_calmar, anchor_neg, trades_list=None):
    ...
    # Check median stop if trades list provided
    tick_ok = True
...
def main():
    ...
    # -- 4. ENTRY END TIME -----------------------------------------------------
    entry_ends = ["10:15", "10:30", "10:45", "11:00", "11:30", "12:00", "12:30", "13:00", "14:00", "15:30"]
    ...
    # -- 5. FLAT START TIME ----------------------------------------------------
    flat_starts = ["11:30", "12:00", "12:30", "13:00", "13:30", "14:00", "14:30", "15:00", "15:50"]
    ...
    # -- 9. MIN GAP ATR % -----------------------------------------------------
    gap_vals = [0.5, 1.0, 1.5, 2.0, 2.5, 3.0, 4.0]
