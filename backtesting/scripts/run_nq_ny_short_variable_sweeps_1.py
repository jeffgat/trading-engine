#!/usr/bin/env python3
"""NQ NY Continuation Short — Variable Sweeps Round 1.

R1 anchor (from baseline best alternative):
  ORB: 09:30-09:50 (20m), entry until 15:30, flat 15:50-16:00
  stop=5.0%, min_gap_atr=1.0%, max_gap_pts=0, max_gap_atr=0
  rr=2.0, tp1=0.5, ATR=14, direction=short, ICF=OFF, continuation, 1s magnifier
  DOW gate: none
