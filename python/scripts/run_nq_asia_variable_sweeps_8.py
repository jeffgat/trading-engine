#!/usr/bin/env python3
"""NQ Asia ORB — Variable sweeps round 8 (R4): post bug fix, updated anchor.

R3 (sweeps_7) adopted 1 change:
  - tp1_ratio: 0.20 -> 0.10 (Δ+6.83)
...
ANCHOR = StrategyConfig(
    ...
    rr=1.75,
    tp1_ratio=0.10,          # R3 adopted (was 0.20)
    atr_length=5,
    impulse_close_filter=False,
    name="NQ Asia R5-R4 Anchor",
)
...
def main():
    print("NQ Asia ORB — Round 8 (R4): tp1=0.10")
    print("=" * 90)
    ...
    # ── 4. ENTRY END TIME ────────────────────────────────────────────
    entry_ends = ["22:00", "23:00", "23:30", "00:00", "00:30", "01:00"]
