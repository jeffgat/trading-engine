#!/usr/bin/env python3
"""NQ NY Continuation — Variable Sweeps Round 2 (Longs-Only Fresh Start).

R2 anchor (R1 + 3 adoptions):
  ORB: 09:30-09:50 (20m), entry until 12:00, flat 15:50-16:00
  stop=9.0%, min_gap_atr=2.5%, max_gap_pts=100.0, max_gap_atr=0.0
  rr=3.0, tp1=0.5, ATR=12, direction=long, ICF=OFF, continuation, 1s magnifier
  DOW gate: excl Fri

R1 adoptions applied:
  entry_end: 15:30 -> 12:00 (+1.97)
  dow_exclusion: none -> excl Fri (+1.86)
  rr: 2.5 -> 3.0 (+1.49)
