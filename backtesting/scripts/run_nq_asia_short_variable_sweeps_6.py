#!/usr/bin/env python3
"""NQ Asia Continuation SHORT — Variable Sweeps Round 6.

R6 anchor (R5 + rr=3.75):
  ORB: 20:00-20:10, entry until 01:00, flat 23:00-07:00
  stop=3.5%, min_gap_atr=1.0%, max_gap_pts=0, max_gap_atr=0
  rr=3.75, tp1=0.6, ATR=30, direction=short, ICF=ON, continuation, 1s magnifier
  DOW gate: excl Thu

R5 adoption: rr 3.5->3.75 (+0.45)
...
def main():
    ...
    # -- 7. REWARD:RISK --------------------------------------------------------
    rr_vals = [3.0, 3.25, 3.5, 3.75, 4.0, 4.25, 4.5, 5.0, 6.0]
