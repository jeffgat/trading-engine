#!/usr/bin/env python3
"""NQ Asia Continuation — Variable Sweeps Round 7.

R7 anchor (R6 + flat revert to 04:00):
  ORB: 20:00-20:15, entry until 03:00, flat 04:00-07:00
...
R6 adoptions applied: flat: 23:00 -> 04:00 (+4.44)
  flat=23:00 was too aggressive (killed performance)
  All flat values >=04:00 give identical results (no trades open past 04:00)
  ORB oscillation (15m<->30m) continuing — keeping 15m, grid will resolve
  entry_end=00:00 deferred (borderline delta +0.53)
