#!/usr/bin/env python3
"""Prop firm phase 1 analysis for ES Asia Long config (2x risk config).

No optimization — run the existing config and simulate staggered
prop firm accounts at both 1x and 2x risk levels.
"""
...
CONFIG = StrategyConfig(
    ...
    tp1_ratio=0.3,
    atr_length=5,
    name="ES Asia Long — Prop Firm Phase 1",
)
...
def main():
    ...
    print("ES Asia Long — Prop Firm Phase 1 Analysis")
    print("=" * 70)
    print(f"Config: continuation, long, rr=1.75, tp1=0.3, stop=2.5%, gap=1.0%")
    print(f"        ORB=10m (20:00-20:10), entry<=03:00, flat=06:45, ATR=5")
