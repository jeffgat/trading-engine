#!/usr/bin/env python3
"""NQ Asia Continuation — Variable Sweeps Round 6 (RESTART).

R6 anchor (R5 + entry_end=23:00, maxgap=75pts):
...
R5 adoptions applied: entry_end: 23:15 -> 23:00 (+0.35), maxgap: 50 -> 75pts (+0.62)
...
ANCHOR = StrategyConfig(
    ...
    name="NQ Asia R6 Anchor (restart)",
)
