#!/usr/bin/env python3
"""ES Asia Continuation — Variable Sweeps Round 5.

R5 anchor (adopted from R4):
...
R4 adoption (Calmar Δ > +0.3, no new neg years):
  tp1:  0.3 → 0.5 (+0.35)
...
def main():
    print("ES Asia ORB — Round 5: re-sweep on R4 adopted anchor (tp1=0.5)")
    print("=" * 90)
