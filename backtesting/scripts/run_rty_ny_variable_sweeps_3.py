#!/usr/bin/env python3
"""RTY NY Continuation — Variable Sweeps Round 3.

R3 anchor (adopted from R2):
  gap=0.5% (Calmar Δ +0.35, no new neg years)
  direction=long, rr=4.0 (from R1)
  Everything else: defaults (stop=7.5%, tp1=0.5, ATR=14, 15m ORB, entry≤12:00)

Key re-sweeps: entry_end and stop were near-misses at R2 anchor. Re-sweep at new gap=0.5%.
...
def main():
    ...
    # ── Anchor ──
    print("=" * 100)
    print("  ANCHOR (R3: long, rr=4.0, gap=0.5%)")
    print("=" * 100)
    ...
    # ── 1. Entry end (re-sweep — near-miss at R2) ──
    print("=" * 100)
    print("  SWEEP 1: Entry End Time (re-sweep)")
    print("=" * 100)
    print(HDR)
    ...
    # ── 2. Stop ATR % (re-sweep — near-miss at R2) ──
    print("=" * 100)
    print("  SWEEP 2: Stop ATR % (re-sweep)")
    print("=" * 100)
    print(HDR)
    for i, s in enumerate([2.0, 2.5, 3.0, 3.5, 4.0, 5.0, 6.0, 7.5, 9.0, 10.0], 1):
    ...
    # ── 5. R:R fine-tune ──
    print("=" * 100)
    print("  SWEEP 5: Risk-Reward Ratio")
    print("=" * 100)
    print(HDR)
    for i, rr in enumerate([3.0, 3.5, 4.0, 4.5, 5.0, 5.5, 6.0], 1):
    ...
    # ── 8. Gap fine-tune (around adopted 0.5%) ──
    print("=" * 100)
    ...
    print("=" * 100)
    print("  R3 COMPLETE — Review sweeps above and adopt changes with Calmar Δ > +0.3")
    print("=" * 100)
